...
def index(request: HttpRequest):
    """Página inicial da área do Aluno"""
    ...
    response, aluno = conn.consultar.aluno(token, id)
    context = {
        "erros":[]
    }

    print(cargo, utils.Cargo.ALUNO)
    ...
    elif response.status_code == 403 or cargo != utils.Cargo.ALUNO:
